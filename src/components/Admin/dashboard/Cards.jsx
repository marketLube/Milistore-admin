    ...
    if (data == "Total Orders") {
      return (
        <div className={` bg-[#00BA9D] p-2 flex items-center`}>
          <IoDiamondSharp className="text-4xl text-white" />
        </div>
      );
    }
    if (data == "Total Deliveries") {
      return (
        <div className={` bg-[#FF5470] p-2 flex items-center`}>
          <AiOutlineDeliveredProcedure className="text-4xl text-white" />
        </div>
      );
    }
    if (data == "Total Revenue") {
      return (
        <div className={` bg-[#035ECF] p-2 flex items-center`}>
          <GiMoneyStack className="text-4xl text-white" />
        </div>
      );
    }
  };
